...
DESCRIPTION = metadata.get('description', 'Repository for creating ECO synthetic catalogues using Conditional Abundance Matching (CAM)')
AUTHOR = metadata.get('author', 'Victor Calderon and Duncan Campbell')
