...
using the 'Conditional Abundance Matching' (CAM) framework
"""
...
def get_parser():
    ...
    parser.add_argument('-nmin',
                        ...
                        metavar='[1-1000]',
                        default=1)
    ## Choice of linking length - Perpendicular
    parser.add_argument('-l_perp',
                        dest='l_perp',
                        help='Perpendicula linking length. Default: 0.07',
                        type=_check_pos_val,
                        default=0.07)
    ## Choice of linking length - Parallel
    parser.add_argument('-l_para',
                        dest='l_para',
                        help='Parallel linking length. Default: 1.1',
                        type=_check_pos_val,
                        default=1.1)
    ## Random Seed
...
def hmf_calc(cosmo_model, proj_dict, param_dict, Mmin=10, Mmax=16, 
    ...
    Prog_msg='1 >>   '):
    # Prog_msg=cfutils.Program_Msg(__file__)):
    """
